...
enum Status {
    ...
    BADREADOFFSET,BADWRITEOFFSET,
    BADREADSIZE,BADWRITESIZE,
    ...
    SCANTABFULL, FILEEOF, FILEHDRFULL, FILEFULL,
    ...
    // Query错误
    ATTRTYPEMISMATCH, TMP_RES_EXISTS, ATTRNUMBERMISMATCH, ATTRVALUENULL,
